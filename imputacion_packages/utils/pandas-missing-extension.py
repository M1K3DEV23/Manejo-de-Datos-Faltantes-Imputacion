...
class MissingMethods:
    ...
    def scatter_imputation_plot(
        self, x: str, y: str, imputation_suffix="_imp", show_marginal=False, **kwargs
    ):
    ...
    def missing_mosaic_plot(
        self, target_var: str, x_categorical_var: str, y_categorical_var: str, ax=None
    ):
        return (
            self._obj.assign(
                **{
                    target_var: lambda df: df[target_var]
                    .isna()
...
class Visualization:
    ...
    def multiple_viz_inputations(self, variables: list[str] = None, **kwargs):
        return (
            self._obj.select_columns(variables)
